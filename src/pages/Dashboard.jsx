...
export default function Dashboard() {
  ...
  return (
    <DashLayout>
      ...
      {/* Daily Quote Card - FIXED: No rotation */}
      <div className={`max-w-md transition-all duration-700 delay-200 mb-8 md:mb-12 ${
        mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
      }`}>
        <div className="bg-warning p-4 md:p-6 rounded-xl shadow-[0_12px_40px_rgba(255,230,109,0.3)] hover:shadow-[0_20px_60px_rgba(255,230,109,0.5)] transition-shadow">
      ...
      {/* Feature Grid - FIXED: No emojis, no rotation, aligned properly */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        >
          <div className="bg-[#FFDAB9] p-6 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_20px_60px_rgba(255,218,185,0.3)] transition-all">
