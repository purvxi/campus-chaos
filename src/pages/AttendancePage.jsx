      ...
      <PageTransition>
        ...
        <div className="mb-6 md:mb-8">
          ...
          <p className="text-sm md:text-base text-muted">
            Monitor your presence (or strategic absence)
          </p>
        </div>
        ...
        <div className="bg-card p-4 md:p-6 rounded-xl shadow-md border border-txt/10 mb-6 md:mb-8">
          ...
          <h2 className="text-lg md:text-xl font-semibold text-txt mb-4">
            Add New Subject
          </h2>
            ...
            <div className="w-full sm:w-32">
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    required: parseInt(e.target.value) || 75
                  })
                }
                className="w-full px-4 py-2 rounded-lg border border-txt/20 bg-bg focus:outline-none focus:ring-2 focus:ring-accent text-sm"
                min="0"
          ...
          <p className="text-xs text-muted mt-3 italic">
            💡 <strong>Required %:</strong> Usually 75% in most colleges
          </p>
        ...
        {subjects.length === 0 ? (
          ...
          <div className="bg-[#FFDAB9] p-8 md:p-12 rounded-xl text-center">
            <p className="text-txt text-lg md:text-xl font-semibold mb-2">
              No subjects yet!
            </p>
            <p className="text-txt/70 text-sm md:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            ...
            {subjects.map((subject, index) => {
              ...
              return (
                ...
                <div
                  key={subject.id}
                  className="bg-card p-4 md:p-6 rounded-xl shadow-md border border-txt/10 hover:shadow-lg transition-all"
                >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-txt/10 rounded-full h-2 overflow-hidden">
                      ...
                      <div
                        ...
                        : 'bg-danger'}`}
                        style={{
                          width: `${Math.min(Number(status.percentage), 100)}%`
                        }}
                      />
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="flex-1 bg-success text-txt font-semibold py-2 rounded-lg"
                    >
                      ✓ Present
                    </button>
